            ...
            <form method="POST" action="{{ route('2fa.verify') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="otp" id="otp" required autofocus
                        class="mt-1 block w-full px-4 py-2 text-lg border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-800"
                        placeholder="xxxxxx">
                </div>
